<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="admin/loaitin/danhsach"><i class="fa fa-pencil fa-fw"></i> Loại Bài<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="admin/tintuc/danhsach"><i class="fa fa-book fa-fw"></i> Lá Bài<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="admin/slide/danhsach"><i class="fa fa-spinner fa-spin fa-1x fa-fw"></i> Slide<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
